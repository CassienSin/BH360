...
import { createTicket, addMessageToTicket, type Ticket as TicketType } from '../../store/slices/ticketSlice';
...
const AIHelpDesk = () => {
  ...
  const [ticketData, setTicketData] = useState({
    title: '',
    category: 'general' as 'general' | 'incident' | 'complaint' | 'request' | 'other',
          ...
          <Stack spacing={3} sx={{ pt: 1 }}>
            ...
            <TextField
              ...
              onChange={(e) =>
                setTicketData({
                  ...ticketData,
                  category: e.target.value as typeof ticketData.category,
                })
              }
              required
              fullWidth
            ...
            <TextField
              ...
              onChange={(e) =>
                setTicketData({
                  ...ticketData,
                  priority: e.target.value as typeof ticketData.priority,
                })
              }
              required
              fullWidth
